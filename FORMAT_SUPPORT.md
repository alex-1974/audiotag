...
| MPEG Audio / MP3 | ID3v1 | Core | — | Raw fixed-size ID3v1.0/ID3v1.1 tag parser, strict ISO-8859-1 text decoding, canonical title/artist/album/comment projection and zero-copy MP3 trailing-tag locator; year/track/genre canonical semantics and writer still pending |
