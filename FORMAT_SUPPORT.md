...
| MPEG Audio / MP3 | ID3v1 | Core | Core | Raw fixed-size ID3v1.0/ID3v1.1 parser and deterministic 128-byte tag writer; strict ISO-8859-1 text codec; canonical title/single-artist/album/comment, year-only `releaseDate`, ID3v1.1 track and recognized genre projection/writeback with native-only byte preservation; zero-copy MP3 trailing-tag location plus complete in-memory suffix insertion/replacement/removal; POSIX path-based suffix update is still pending |
