...
| MPEG Audio / MP3 | ID3v1 | Core | — | Raw fixed-size ID3v1.0/ID3v1.1 tag parser, strict ISO-8859-1 text decoding, canonical title/artist/album/comment, four-digit release year, ID3v1.1 track and recognized genre projection, plus zero-copy MP3 trailing-tag locator; malformed year text and unknown genre bytes remain native, writer still pending |
