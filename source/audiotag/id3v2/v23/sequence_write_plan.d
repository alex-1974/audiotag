...
frame sequence.
+/
struct Id3v23FrameSequenceWriteEntry
{
...
+/
struct Id3v23FrameSequenceWritePlan
{
private:
    Id3v23FrameSequenceWriteEntry[] _entries;
...
public:
    ...
    +/
    @property
    const(Id3v23FrameSequenceWriteEntry)[] entries() const
    ...
    @safe
{
    ...
    auto result =
        Id3v23FrameSequenceWritePlan.init;
