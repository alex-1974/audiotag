/++
Common result types for mapping native ID3v2.3 metadata to the
...
- unsupported or currently unrepresentable native semantics are not
  parser failures.
+/
module audiotag.id3v2.v23.canonical_mapping;
...
/++
Outcome of attempting to map one native ID3v2.3 semantic value to one
canonical metadata field.
+/
enum Id3v23CanonicalMappingStatus : ubyte
{
...
/++
Result of mapping one native ID3v2.3 semantic value to canonical
metadata.
...
+/
struct Id3v23CanonicalMappingResult
{
    /// Mapping outcome.
    ...
    +/
    static Id3v23CanonicalMappingResult success(
        MetadataField field
    )
        @safe
    {
    ...
    mapper.
    +/
    static Id3v23CanonicalMappingResult unsupported()
        @safe pure nothrow @nogc
    {
        return
            Id3v23CanonicalMappingResult(
                Id3v23CanonicalMappingStatus.unsupportedFrame,
                MetadataField.init
            );
    }
    ...
    +/
    static Id3v23CanonicalMappingResult transformationRequired()
        @safe pure nothrow @nogc
    {
        return
            Id3v23CanonicalMappingResult(
                Id3v23CanonicalMappingStatus.requiresTransformation,
                MetadataField.init
            );
    }
    ...
    +/
    static Id3v23CanonicalMappingResult unrepresentable()
        @safe pure nothrow @nogc
    {
        return
            Id3v23CanonicalMappingResult(
