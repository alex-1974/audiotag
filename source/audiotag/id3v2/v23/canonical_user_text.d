/++
Canonical mapping for ID3v2.3 user-defined text (`TXXX`) frames.
...
ID3v2.3-specific character decoding, including independent Unicode BOM
handling for description and value, is completed by the native codec
before this mapping layer is reached.

Transformation-pending native outcomes remain valid metadata and return
`requiresTransformation`.
+/
module audiotag.id3v2.v23.canonical_user_text;
...
/++
Maps one decoded ID3v2.3 `TXXX` frame to canonical `userText`.
...
+/
Id3v23CanonicalMappingResult
mapId3v23UserTextFrameToCanonical(
    Id3v23UserTextFrame frame,
...
/++
Maps one unified native ID3v2.3 frame through the TXXX canonical mapper.
...
/// Empty TXXX values remain explicit scalar canonical text.
unittest
{
    Id3v23UserTextFrame frame;
