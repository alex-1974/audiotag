...
For a whole-tag-unsynchronised source this writer still emits only
logical bytes. Physical source stuffing is never copied into that
logical representation; an existing extended header is regenerated by
...
/// An unsynchronised source is rebuilt as an ordinary logical body.
unittest
{
    const ubyte[] sourceBytes =
        [
