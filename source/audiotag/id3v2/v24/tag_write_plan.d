/++
Complete semantic write planning for one canonical ID3v2.4 tag edit.
...
import audiotag.id3v2.v24.edit_mutation :
...
import audiotag.id3v2.v24.sequence_write_plan :
...
+/
enum Id3v24ExistingFrameRegenerationStatus : ubyte
{
    ready,
...
+/
struct Id3v24ExistingFrameRegenerationPlan
{
    ...
    Id3v24ExistingFrameRegenerationStatus status;

    /// Canonical-field target plan when the shape is supported.
    Id3v24CanonicalFieldPlan fieldPlan;
...
/++
Complete semantic write plan for one edited ID3v2.4 tag.
...
+/
struct Id3v24TagWritePlan
{
private:
    Id3v24ExistingFrameRegenerationPlan[] _regenerations;
    Id3v24NewFramePlan[] _newFrames;
...
public:
    ...
    Id3v24FrameSequenceWritePlan existingFrames;
    ...
    +/
    @property
    const(Id3v24ExistingFrameRegenerationPlan)[]
    regenerations() const
        @safe pure nothrow @nogc
    {
    ...
    +/
    @property
    const(Id3v24NewFramePlan)[] newFrames() const
        @safe pure nothrow @nogc
    {
        return _newFrames;
    }
